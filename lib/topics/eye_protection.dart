...
class _EyeProtectionPageState extends State<EyeProtectionPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("Eye Protection")),
      body: Padding(
        ...
        child: Column(
          children: [
            Expanded(
              child: ListView(
                children: [
                  _buildQuestionAnswer("👁️ What is eye protection?", "Eye protection involves using specialized PPE such as safety goggles or face shields to prevent injury from flying debris, chemicals, or light radiation."),
                  ...
                  _buildQuestionAnswer("👁️ What are common hazards to the eyes?", "Flying particles, splashes of harmful liquids, intense light or radiation, and dust."),
                  ...
                  _buildQuestionAnswer("👁️ How should eye PPE fit?", "It should fit snugly without obstructing vision or causing discomfort."),
                  ...
                  _buildQuestionAnswer("👁️ Can ordinary glasses replace safety goggles?", "No. Regular glasses are not impact-resistant or sealed and cannot replace certified eye protection."),
                  ...
                  _buildQuestionAnswer("👁️ Who is responsible for eye safety?", "Both employers and employees share responsibility: providing and properly using PPE."),
