        ...
        child: Column(
          children: [
            Expanded(
              child: ListView(
                children: [
                  _buildQuestionAnswer("😷 What is respiratory protection?", "It includes devices such as respirators and face masks used to protect against inhaling harmful substances."),
                  ...
                  _buildQuestionAnswer("😷 Can anyone use any respirator?", "No, proper fit-testing and selection based on hazard are necessary."),
                  ...
                  _buildQuestionAnswer("😷 What is a respirator cartridge?", "A replaceable filter that purifies air passing through the respirator."),
